...
class SteadyStatePure(AbstractVariationalDriver):
    """
    ...
    def __init__(
        ...
        """
        super(SteadyStatePure, self).__init__(
    ...
    def n_samples(self, n_samples):
        ...
        self._n_samples_node_half = int(math.ceil(n_samples_chain / self.n_nodes))
        self._n_samples_node = self._n_samples_node_half * 2
    ...
    def _forward_and_backward(self):
        ...
        if self._sr:
            ...
            self._grads = trees2_map(
                lambda x, y: x + y, self._grads_σ_a, self._grads_η_b
            )
    ...
    def _get_mc_superop_stats(self, op):
        ...
        loc = _local_values(op, self._machine, (self._σ_a, self._η_b)).reshape(
            (self._n_samples_node_half,) + self._samples.shape[1:2],
        )
