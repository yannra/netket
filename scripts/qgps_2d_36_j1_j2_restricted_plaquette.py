...
if mode == 0:
    ...
    ma = nk.machine.QGPSProdSym(hi, n_bond=N, automorphisms=transl, spin_flip_sym=True, cluster_ids=plaquette_ids, dtype=complex)
elif mode == 2:
    ma = nk.machine.QGPSSumSymExp(hi, n_bond=N, automorphisms=transl, spin_flip_sym=True, cluster_ids=plaquette_ids, dtype=complex)
else:
    ma = nk.machine.QGPSProdSymExp(hi, n_bond=N, automorphisms=transl, spin_flip_sym=True, cluster_ids=plaquette_ids, dtype=complex)
