...
if mode == 0:
    ma = nk.machine.QGPSSumSym(hi, n_bond=N, automorphisms=None, spin_flip_sym=False, cluster_ids = cluster_ids, dtype=complex)
elif mode == 1:
    ma = nk.machine.QGPSProdSym(hi, n_bond=N, automorphisms=None, spin_flip_sym=False, cluster_ids = cluster_ids, dtype=complex)
elif mode == 2:
    ma = nk.machine.QGPSSumSymExp(hi, n_bond=N, automorphisms=None, spin_flip_sym=False, cluster_ids = cluster_ids, dtype=complex)
else:
    ma = nk.machine.QGPSProdSymExp(hi, n_bond=N, automorphisms=None, spin_flip_sym=False, cluster_ids = cluster_ids, dtype=complex)
